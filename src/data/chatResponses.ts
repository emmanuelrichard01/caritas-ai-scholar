...
export const findResponse = (query: string): string => {
  ...
  const keywordMap: { [key: string]: string } = {
    [APP_CONFIG.university.name.toLowerCase()]: `What can you tell me about ${APP_CONFIG.university.name}?`,
    [APP_CONFIG.university.slug.toLowerCase()]: `What can you tell me about ${APP_CONFIG.university.name}?`,
    "university": `What can you tell me about ${APP_CONFIG.university.name}?`,
