    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 text-center dark:bg-slate-900 border-2 border-blue-200 dark:border-blue-800">
          ...
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{analytics.completedTasks}</div>
        ...
        <Card className="p-4 text-center dark:bg-slate-900 border-2 border-blue-200 dark:border-blue-800">
          ...
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{Math.round(analytics.efficiency)}%</div>
        ...
        <Card className="p-4 text-center dark:bg-slate-900 border-2 border-blue-200 dark:border-blue-800">
          ...
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{analytics.streak}</div>
      ...
      {/* Study Tips */}
      <Card className="p-6 dark:bg-slate-900 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-2 border-blue-200 dark:border-blue-800">
